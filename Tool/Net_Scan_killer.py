...
subtitle = "Net_Scan_Killer : Tools for Scanning Devices;\n(OS detection - limited) (faster than Netdiscover)"
author_tag = "Built By Ayoub AitBendaoud"
print(ascii_banner)
print(" " * 35 + author_tag)
print()
print(subtitle)
...
def get_arguments():
    ...
    parser.add_argument("-f", "--fastMode", action="store_true", help="Enable fast mode to scan automatically and continuously")
